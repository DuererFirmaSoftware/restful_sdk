...
public class ArticlesRequestPerformer {

	JSONObject article = null;
	ArrayList<JSONObject> objectList = new ArrayList<>();
	public ArticlesRequestPerformer(String address, RequestType type, String articleName, String token) {
		HashMap<String, String> params = new HashMap<>();
		params.put("token", token);
		String usedAddress = articleName != null ? address + articleName : address;
